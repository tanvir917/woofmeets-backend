export class PaymentAppointmentForProviderTemplate {
  html() {
    return `
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p10b es-p15r es-p15l" align="left">
                                                                                            ...
                                                                                            <p>Your appointment has paid successfully by pet owner. Please, check your appointment at <i>woofmeets.com.</p>
                                                                                            <p>Now, your appointment status is <b style="color:red;"> PAID. </p>
                                                                                            <p>Congratulations for your new Appointment.</p>
