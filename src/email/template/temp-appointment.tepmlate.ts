export class TempAppointmentTemplate {
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td class="esd-block-text es-p10b es-p15r es-p15l" align="left">
                                                                                            ...
                                                                                            <p>Your appointment status is changed. Please, check your appointment at <i>woofmeets.com.</p> 
                                                                                            <p>Now, your appointment status is <b style="color:red;"> ${this.status}. </p>
